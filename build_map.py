...
MANUAL_PLOT_COORDS = {
    ...
    # --- Col5-L upper: 283 (tall top), 282 (tall), 281 (tall), 280, 279 ---
    '283': [(361.5,283.0), (371.0,287.0), (372.0,319.0), (361.5,319.0)],
    '282': [(361.5,319.0), (372.0,319.0), (373.0,347.0), (361.5,347.0)],
    '281': [(361.5,347.0), (373.0,347.0), (374.0,376.0), (361.5,376.0)],
    '280': [(361.5,376.0), (374.0,376.0), (374.0,390.0), (361.5,390.0)],
    '279': [(361.5,390.0), (374.0,390.0), (375.0,400.3), (361.5,400.3)],
    # --- Col5-L lower: 278-267 (regular rows, right edge widens) ---
    '278': [(361.5,408.3), (375.0,408.3), (375.0,418.6), (361.5,418.6)],
    '277': [(361.5,418.6), (375.0,418.6), (375.3,432.9), (361.5,432.9)],
    '276': [(361.5,432.9), (375.3,432.9), (375.7,447.2), (361.5,447.2)],
    '275': [(361.5,447.2), (375.7,447.2), (376.0,461.5), (361.5,461.5)],
    '274': [(361.5,461.5), (376.0,461.5), (382.0,475.8), (361.5,475.8)],
    '273': [(361.5,475.8), (382.0,475.8), (382.0,490.1), (361.5,490.1)],
    '272': [(361.5,490.1), (382.0,490.1), (382.0,504.4), (361.5,504.4)],
    '271': [(361.5,504.4), (382.0,504.4), (382.0,518.7), (361.5,518.7)],
    '270': [(361.5,518.7), (382.0,518.7), (382.0,533.0), (361.5,533.0)],
    '269': [(361.5,533.0), (382.0,533.0), (382.0,547.3), (361.5,547.3)],
    '268': [(361.5,547.3), (382.0,547.3), (382.0,561.6), (361.5,561.6)],
    '267': [(361.5,561.6), (382.0,561.6), (382.0,597.9), (361.5,595.9)],
    # --- Col5-R: 284-290 (right column, starts at 273 level) ---
    '284': [(382.0,475.8), (402.5,476.8), (402.5,490.1), (382.0,490.1)],
    '285': [(382.0,490.1), (402.5,490.1), (402.5,504.4), (382.0,504.4)],
    '286/A': [(382.0,504.4), (402.5,504.4), (402.5,511.6), (382.0,511.6)],
    '286/B': [(382.0,511.6), (402.5,511.6), (402.5,518.7), (382.0,518.7)],
    '287': [(382.0,518.7), (402.5,518.7), (402.5,533.0), (382.0,533.0)],
    '288': [(382.0,533.0), (402.5,533.0), (402.5,547.3), (382.0,547.3)],
    '289': [(382.0,547.3), (402.5,547.3), (402.5,561.6), (382.0,561.6)],
    '290': [(382.0,561.6), (402.5,562.6), (402.5,598.9), (382.0,597.9)],
    # --- Col6-L: 296 (angled top), 295-292 (regular), 291 (unique bottom) ---
    '296': [(408.7,479.0), (429.2,482.0), (429.2,504.3), (409.7,504.3)],
    '295': [(409.7,504.3), (429.2,504.3), (429.2,518.7), (409.7,518.7)],
    '294': [(409.7,518.7), (429.2,518.7), (429.2,533.1), (409.7,533.1)],
    '293/B': [(409.7,533.1), (429.2,533.1), (429.2,540.4), (409.7,540.4)],
    '293/A': [(409.7,540.4), (429.2,540.4), (429.2,547.6), (409.7,547.6)],
    '292': [(409.7,547.6), (429.2,547.6), (429.2,562.0), (409.7,562.0)],
    '291': [(409.7,562.0), (429.2,562.0), (429.2,601.0), (409.7,599.0)],
    # --- Col6-R: 297 (angled top), 298-301 (regular), 302 (unique bottom) ---
    '297': [(429.2,482.0), (450.4,485.0), (450.4,504.3), (429.2,504.3)],
    '298': [(429.2,504.3), (450.4,504.3), (450.4,518.7), (429.2,518.7)],
    '299': [(429.2,518.7), (450.4,518.7), (450.4,533.1), (429.2,533.1)],
    '300': [(429.2,533.1), (450.4,533.1), (450.4,547.6), (429.2,547.6)],
    '301': [(429.2,547.6), (450.4,547.6), (450.4,562.0), (429.2,562.0)],
    '302': [(429.2,562.0), (450.4,562.0), (450.4,603.0), (429.2,601.0)],
    # --- Col7: 308-305 (trapezoids, diagonal road on right), 303+304 (side by side bottom) ---
    '308': [(456.4,491.0), (456.0,490.0), (476.0,533.0), (456.4,533.0)],
    '307': [(456.4,533.0), (476.0,533.0), (483.0,548.0), (456.4,548.0)],
    '306': [(456.4,548.0), (483.0,548.0), (490.0,562.0), (456.4,562.0)],
    '305': [(456.4,562.0), (490.0,562.0), (497.0,577.0), (456.4,577.0)],
    '303': [(456.4,577.0), (477.0,577.0), (478.0,605.0), (456.4,603.0)],
    '304': [(477.0,577.0), (497.0,577.0), (512.0,608.0), (478.0,605.0)],
}
